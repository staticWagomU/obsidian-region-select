...
const scrum: ScrumDashboard = {
  ...
  // Active improvements only (completed: type-safe wrappers, ViewPlugin docs, README, main.ts integration tests)
  retrospectives: [
    {
      sprint: 5,
      improvements: [
        { action: "main.tsの統合テストを追加する", timing: "sprint", status: "completed", outcome: "Sprint 6 Subtask 7で完了: src/main.test.ts追加、アーキテクチャ契約を文書化" },
